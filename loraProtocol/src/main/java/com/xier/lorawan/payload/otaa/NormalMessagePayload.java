...
import com.xier.lorawan.payload.AbstractAcceptPayload;
 ...
 */
public class NormalMessagePayload extends AbstractAcceptPayload {
    private Logger logger = LoggerFactory.getLogger(NormalMessagePayload.class);
    ...
    public NormalMessagePayload(String applicationKey,PHYPayload phyPayload) {
    ...
    public byte[] reCalculateMic(){
        ...
        return loraPayloadAesCrypto.calcMic(appKey,byteBuffer.array());
    }
